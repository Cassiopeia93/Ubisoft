...
transactionDataFrameTemp=transactionDataFrame.withColumn('nb_distinct_char_in_address', cnt(col("address"))).withColumn('ls_located_in_rue_de_paris', check(col("address")))
transactionDataFrameTemp.show()
